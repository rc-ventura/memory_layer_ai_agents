...
- Existe um "monorepo" — um mapeamento assistido por Claude sobre cerca de 130 repositórios — que indexa onde cada agente vive, sua arquitetura, e seus pontos de entrada; o tutor ia mandar o link.
