...
**Decisão/próximo passo:** Registrado o formato do loop v2 em [`discussion/knowledge-as-infra-architecture-hypothesis.md`](../../discussion/hipoteses/knowledge-as-infra-architecture-hypothesis.md) §C (nota datada, marcada como v2 / fora do escopo v1). O pré-requisito continua sendo construir o **replay harness com ferramentas mockadas** — sem ele, o v1 fica com "escreve memória → observa reincidência nas execuções reais seguintes", sem simulador.
