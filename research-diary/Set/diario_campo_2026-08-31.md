...
Resumo factual da reunião em [`docs/checkpoints/checkpoint-2026-08-28-tutor.md`](../../docs/checkpoints/checkpoint-2026-08-28-tutor.md); reflexões cross-cutting em [`discussion/checkpoint-2026-08-28-reflections.md`](../../discussion/reflexoes/checkpoint-2026-08-28-reflections.md); atualizações datadas em `open-questions.md`, no doc de arquitetura e no `scope-and-terminology-decisions.md` (feitas na mesma sessão).
