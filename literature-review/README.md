...
- [`visual-synthesis/`](visual-synthesis/) — two mind maps of the field's anchor surveys: Zhang et al. (ACM TOIS 2025) and Hu/Liu et al. ("Memory in the Age of AI Agents," 2025), logged in the [research diary on 18/08/2026](../research-diary/Ago/diario_campo_2026-08.md). Each ships as a rendered PNG plus its editable Mermaid source.
