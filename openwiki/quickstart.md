...
type: quickstart
title: Quickstart
description: Mapa de navegação por tarefa de pesquisa comum neste repositório — onde registrar um achado, processar uma reunião, contribuir uma leitura, entender a arquitetura proposta, ou rodar uma análise de trace.
...
| Rodar ou entender uma análise empírica de trace bruto de agente | [Metodologia de Análise de Traces](fluxos/metodologia-de-analise-de-traces.md) → `analysis/README.md` |
