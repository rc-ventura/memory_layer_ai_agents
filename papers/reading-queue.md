...
**GraphRAG — ativado 20/08/2026, motivo revisado 24/08/2026 depois da transcrição real da reunião de infra (21/08) chegar.** Não foi o fluxo jurídico que decidiu (essa pergunta segue em aberto — ver [`../discussion/open-questions.md`](../discussion/open-questions.md)). O motivo original registrado aqui — "Fed já está construindo memória com GraphRAG" — **overclaimava**: a transcrição real ([`../docs/checkpoint-2026-08-21-infra-arquitetura.md`](../docs/checkpoint-2026-08-21-infra-arquitetura.md), reflexões em [`../discussion/checkpoint-2026-08-21-infra-reflections.md#3`](../discussion/checkpoint-2026-08-21-infra-reflections.md#3-correction-its-langgraph-checkpointing-not-graphrag)) mostra que o Fed está usando **checkpoints de estado do LangGraph** (conversa → checkpoints → resumos incrementais), não GraphRAG (grafo de entidades pra retrieval, à la Microsoft). O Fed mencionou combinar grafo com busca vetorial como possibilidade futura — mais próximo de GraphRAG, mas explicitamente não implementado ainda. Motivo de leitura agora é mais fraco e prospectivo (pode virar relevante se essa combinação futura acontecer, e o panorama geral de RAG/grafo já era do interesse do Rafael independente disso), não mais "avaliar o que já existe". Verificados via busca (título/autores/data confirmados, não lidos ainda):
