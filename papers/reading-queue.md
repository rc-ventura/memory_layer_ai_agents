...
**GraphRAG — ativado 20/08/2026, por um motivo diferente do previsto originalmente.** Não foi o fluxo jurídico que decidiu (essa pergunta segue em aberto — ver [`../discussion/open-questions.md`](../discussion/open-questions.md)); foi a reunião de checkpoint revelar que o "Fed" (engenheiro de infra citado em [`../docs/checkpoint-2026-08-20-tutor-kickoff.md`](../docs/checkpoint-2026-08-20-tutor-kickoff.md)) já está construindo memória de agente em LangChain usando GraphRAG. Motivo de leitura agora é interoperabilidade/Sub 2.5 (avaliar e potencialmente integrar com o que já existe), não mais só "será que o caso de uso precisa de navegação hierárquica". Verificados via busca (título/autores/data confirmados, não lidos ainda):
