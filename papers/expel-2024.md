> **Sub-atividade:** 1.1 · **Status:** Peer-reviewed (AAAI 2024) · **Theme:** Update, consolidation & forgetting
...
---
Source: verified directly against the arXiv abstract and AAAI proceedings page (not from the original bibliographic review docx) — added 19/08/2026 at the user's request, clearing the #1 reading-queue item.
