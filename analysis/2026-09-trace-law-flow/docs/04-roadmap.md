...
| 32 | ~~**`Import from X is not allowed` (base 2)**~~ — **feito em 25/09 (Ajuste 3)**: a regra do sandbox casa `Import of` e `Import from`; base 1 sem mudança. Falta replicar e conferir na base 2 | `../../pipeline-entre-bases.md` §3 Ajuste 3 |
