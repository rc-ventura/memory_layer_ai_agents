...
| [`trail-2505.08638.md`](trail-2505.08638.md) | **TRAIL** — Patronus AI | Dá a taxonomia (20+ tipos, 3 áreas) e o dataset anotado (841 erros, 148 traces) que usamos para **estimar por mapeamento nosso** — não é medida publicada pelo paper — que ≥59% desses erros não levantam exceção. Traz o schema de anotação reusável e as 11 análises executáveis para abrir esse ponto cego. |
