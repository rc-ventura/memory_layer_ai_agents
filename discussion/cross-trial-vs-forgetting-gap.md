...
## First mechanism-level confirmation (24/08/2026, Claude-read via sub-agents, not Rafael-read)

A full-text reading sprint over 8 of the corpus's highest-priority unread papers — see [`reading-sprint-2026-08-24-queue-papers.md`](reading-sprint-2026-08-24-queue-papers.md) for the per-paper detail and the provenance caveat (Claude-read, not Rafael-read) — gives this finding its first confirmation below the survey-table level. Two direct results for this specific gap:
