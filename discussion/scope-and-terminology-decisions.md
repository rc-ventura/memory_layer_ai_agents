...
**Primary source for this decision:** the [20/08 tutor checkpoint](../docs/checkpoint-2026-08-20-tutor-kickoff.md) ([transcript](../docs/sources/Checkpoint_Tutor_2026-08-20.docx)) is where this was actually settled, not just recorded. The tutor described the desired mechanism unprompted ("corrija a memória... para tentar diminuir ao longo do tempo esses casos errados"); Rafael checked it against the RL framing ("só reforçando, não retreinando... mexendo no harness... uma skill nova, uma memória de procedure"); the tutor confirmed ("Perfeito, exatamente isso"). See [`checkpoint-2026-08-20-reflections.md#1`](checkpoint-2026-08-20-reflections.md#1-o-tutor-confirma-de-forma-independente-a-decisão-de-harness-em-vez-de-retreinamento--com-o-vocabulário-exato) for the full exchange and what else that meeting confirms (the cross-agent scope narrowing in decision #3 below also gets real-world corroboration there). Note: that reflections note is kept in Portuguese, at Rafael's request.
